...
//    m_ProgramObj =  GLUtil::CreateProgram(vShaderStr, fShaderStr, m_VertexShader, m_FragmentShader);
    ...
    // the 0 th attribute of the vertex (vertex shader layout in)
    // position attribute
    //                      which,  how many, size,            next,                    where to start,
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
    // after building the logical connection, must set index visible to gpu
